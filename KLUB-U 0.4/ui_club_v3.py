...
# Цвета
BG_COLOR = QColor(45, 47, 50)        # Фон
CELL_BG = QColor(65, 70, 75)         # Чуть светлее фона
GREEN = QColor(0, 255, 0)            # Общий зелёный
YELLOW = QColor(255, 255, 0)         # Общий жёлтый
RED = QColor(255, 0, 0)              # Общий красный
WHITE = QColor(255, 255, 255)        # Общий белый
DARK_GREEN = QColor(0, 50, 0)        # Общий зелёный выкл
DARK_YELLOW = QColor(50, 50, 0)      # Общий жёлтый выкл
DARK_RED = QColor(50, 0, 0)          # Общий красный выкл
CELL_TEXT = QColor(100, 255, 100)    # Остальные ячейки
STATION_TEXT = QColor(200, 150, 50)  # Станиции
